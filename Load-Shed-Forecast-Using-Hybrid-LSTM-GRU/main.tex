...
\cite{akhter2024short}
\cite{baul2024data}
\cite{kumari2022big}
\cite{fahim2024transformation}
\cite{akhtaruzzaman2020hsic}
\cite{sharifhosseini2024investigating}
\cite{aguiar2023insight}
\cite{pallonetto2022forecast}
\cite{ali2024time}
\cite{hasanat2024enhancing}
\cite{veeramsetty2022short}
\cite{asad2025load}
\cite{abumohsen2023electrical}
\cite{jung2021attention}
\cite{mounir2023short}
\cite{hua2024short}
\cite{guo2025power}
\cite{nabavi2024deep}
\cite{han2025residual}
\cite{bashir2022short}
\cite{wu2024power}
\cite{abdulameer2025forecasting}
\cite{baesmat2025hybrid}
\cite{sen2023differential}
\cite{shawon2025hybrid}
